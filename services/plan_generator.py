...
def generate_plan(profile: UserFitnessProfile, session: Session) -> ExercisePlan:
    """
...
def get_active_plan(user_id: str, session: Session) -> Optional[dict]:
    """
    Return the user's active plan as a nested dict:
    {
        "plan": ExercisePlan fields,
